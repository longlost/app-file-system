...
import htmlString from './multiselect-btns.html';
...
class MultiselectBtns extends AppElement {
  static get is() { return 'multiselect-btns'; }
...
window.customElements.define(MultiselectBtns.is, MultiselectBtns);
